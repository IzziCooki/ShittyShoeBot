...
class get_stock():
    ...
    def __init__(self):
        ...
        for entry in temp:
            self.profile_name = entry["Profile Name"]
            self.fname = entry["FirstName"]
        ...
        for entry in temp:
            ...
            self.base_url = "https://www."+ entry["Website"]


            # Search settings
            self.keywords = entry["Keywords"]  # Seperate keywords with a comma
            self.size = "L"
